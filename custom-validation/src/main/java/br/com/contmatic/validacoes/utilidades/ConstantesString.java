...
public class ConstantesString {
    ...
    /** The Constant NOME. */
    public static final String NOME = "[A-ZÁÉÍÓÚÃÕÀÂÊÔÇ &\\-ªº\\.']{1," + (ConstantesNumericas.TAMANHO_REGULAR) + "}";
    ...
    public static final String COMPLEMENTO = "[A-ZÁÉÍÓÚÃÕÀÂÊÔÇ&\\-\\.)('ªº°,:\\/\\\\ ]{1," + (ConstantesNumericas.TAMANHO_REGULAR) + "}";
